...
% Syntax: \newcommandoptionals{\name}[N_OPT][N_MAND][Def1]...{Body}
\newcommandoptionals{\mycmdA}[1][1][DefaultA]{Arg1: #1, Arg2: #2}
...
\newcommandoptionals{\mycmdB}[2][1][DefOne][DefTwo]{Opt1: #1, Opt2: #2, Mand: #3}
...
\newcommandoptionals{\mycmdC}[0][2]{M1: #1, M2: #2}
...
\newcommandoptionals{\mycmdD}[4][4][A][B][C][D]{#1-#2-#3-#4 | #5-#6-#7-#8}
